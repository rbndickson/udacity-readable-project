      ...
      <div>
        ...
        <div className="comment-list-header-button">
          {this.props.newCommentFormOpen
            ? <div>
                <button className="button-small" onClick={ this.closeNewCommentForm }>Close</button>
              </div>
            : <button className="button-small" onClick={ this.openNewCommentForm }>Add New Comment</button>
          }
        </div>
      </div>
    );
